            ...
            <div class="row">
                <div class="col-md-12">
                    <div style="margin: 0 0 20px 0;">
                        ...
                        <span>
                            <a href="{{url('/programs')}}">Телефоны</a>
                        </span>&nbsp;-&nbsp;
                        <span>Редактирование телефона: <span>{{$mobile->name}}</span></span>
                    </div>
                </div>
            </div>
            <div class="card">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                            <div class="card-header" style="text-align: center; font-size: 19px;">
                                ...
                                <span style="font-weight: bold;">{{$mobile->name}}</span>
                            </div>
                            <div class="card-body" style="padding: 20px 0 20px 0; margin: 0;">
                                @csrf

                                @if(isset($mobile->user) && $mobile->user != null)

                                    <div class="form-group row">
                                        <label class="col-md-4 col-form-label text-md-right">{{ __('Закреплен за') }}</label>

                                        <div class="col-md-6">
                                            <input disabled type="text" class="form-control @error('phone_name') is-invalid @enderror" value="{{$mobile->user->name}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="phone_name" type="text" class="form-control @error('phone_name') is-invalid @enderror" name="phone_name" value="{{$mobile->name}}" required autocomplete="phone_name" autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="secret_key" type="text" class="form-control @error('secret_key') is-invalid @enderror" name="secret_key" value="{{$mobile->secret_key}}" required autocomplete="secret_key">
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-md-6 offset-md-4">
                                        <button type="submit" class="btn btn-primary" id="mobiles_save_execute">
                                            {{ __('Сохранить телефон') }}
                                        </button>
                                    </div>
                                </div>
                            </div>
...
<input id="mobile_id" value="{{$mobile->id}}" type="hidden">
@endsection
